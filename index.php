...
//^temporary check during development of 'Remember Me' functionality
?>
		...
		<section class="col-1-1">
			...
			<p>Session:
				...
				if($user->isLoggedIn()){
					...
					<?php
					if($user->hasPermission('admin') && $user->hasPermission('moderator')){//echo permissions
